...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate latest ShadowFormer DESOBA v2 checkpoint with Shadow/Non-shadow/All metrics.")
...
def main():
    ...
    public_arch = args.arch
    if args.arch == "ShadowFormer":
        args.arch = "Homo" + "Former"
    model = utils.get_arch(args)
    args.arch = public_arch
